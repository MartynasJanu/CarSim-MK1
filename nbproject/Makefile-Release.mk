...
${OBJECTDIR}/src/Components/DistributorComponent.o: src/Components/DistributorComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Components/DistributorComponent.o src/Components/DistributorComponent.cpp
...
${OBJECTDIR}/src/Components/IgnitionChamberComponent.o: src/Components/IgnitionChamberComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Components
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Components/IgnitionChamberComponent.o src/Components/IgnitionChamberComponent.cpp
