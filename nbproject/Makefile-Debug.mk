...
OBJECTFILES= \
	...
	${OBJECTDIR}/src/Components/DistributorComponent.o \
	${OBJECTDIR}/src/Components/ElectricswitchComponent.o \
	${OBJECTDIR}/src/Components/IgnitionChamberComponent.o \
...
${OBJECTDIR}/src/Components/DistributorComponent.o: src/Components/DistributorComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Components
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Components/DistributorComponent.o src/Components/DistributorComponent.cpp

${OBJECTDIR}/src/Components/ElectricswitchComponent.o: src/Components/ElectricswitchComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Components
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Components/ElectricswitchComponent.o src/Components/ElectricswitchComponent.cpp

${OBJECTDIR}/src/Components/IgnitionChamberComponent.o: src/Components/IgnitionChamberComponent.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Components
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Components/IgnitionChamberComponent.o src/Components/IgnitionChamberComponent.cpp
